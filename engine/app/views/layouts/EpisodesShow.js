...
class EpisodesShow extends Component {
...
export default connect(({routes, scroll, language, display, player, auth}) => ({routes, scroll, language, display, player, auth}))(EpisodesShow);
