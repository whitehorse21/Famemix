...
class Podcast extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if(nextProps.scroll.podcast && this.props.scroll.podcast !== nextProps.scroll.podcast ) {
        ...
        API.get('podcasts')
            .then(res => {
                    this.setState({
                        ...
                        categories: res.data.podcasts.categories.slice(0, 6),
                        refreshing: false
                    });
